...
class OxygenEditor
{
    ...
    public function iframe_assets()
    {
        ...
        AssetVite::get_instance()->enqueue_asset('assets/oxygen/iframe/main.js', [
            'handle' => OXYBENDER::WP_OPTION . ':iframe',
            'in_footer' => true,
        ]);
    ...
    public function editor_assets()
    {
        ...
        AssetVite::get_instance()->enqueue_asset('assets/oxygen/editor/main.js', [
            'handle' => OXYBENDER::WP_OPTION . ':editor',
            'in_footer' => true,
        ]);
