...
class AdminPage
{
    ...
    public function add_admin_menu()
    {
        $hook = add_submenu_page(
            'ct_dashboard_page',
            __('Yabe Oxybender', 'yabe-oxybender'),
            __('Yabe Oxybender', 'yabe-oxybender'),
            'manage_options',
            OXYBENDER::WP_OPTION,
            fn () => $this->render(),
    ...
    {
        add_filter('admin_footer_text', static fn ($text) => 'Thank you for using <b>Oxybender</b>! Join us on the <a href="https://www.facebook.com/groups/1142662969627943" target="_blank">Facebook Group</a>.', 1_000_001);
        add_filter('update_footer', static fn ($text) => $text . ' | Oxybender ' . OXYBENDER::VERSION, 1_000_001);
