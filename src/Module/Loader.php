...
namespace Yabe\Oxybender\Module;
...
class Loader
{
    ...
    public function scan_modules()
    {
         ...
         */
        do_action('a!yabe/oxybender/module/integration:before_scan', $finder);
    ...
    public function register_modules(): void
    {
        ...
        $modules = apply_filters('f!yabe/oxybender/module/integration:register_modules', $this->modules);
