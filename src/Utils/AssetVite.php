...
namespace Yabe\Oxybender\Utils;
...
class AssetVite
{
    ...
    {
        return $this->_enqueue_asset(dirname(OXYBENDER::FILE) . '/build', $entry, $options);
    }
    ...
    {
        return $this->_register_asset(dirname(OXYBENDER::FILE) . '/build', $entry, $options);
    }
    ...
    {
        return plugins_url('build/', OXYBENDER::FILE);
    }
    ...
    public function get_manifest(string $manifest_dir): object
    {
         ...
         */
        $manifest = apply_filters('f!yabe/oxybender/utils/asset_vite/vite_for_wp__manifest_data', $manifest, $manifest_dir, $manifest_path);
    ...
    public function load_development_asset(object $manifest, string $entry, array $options): ?array
    {
         ...
         * @param array  $options  Enqueue options.
         */
        $assets = apply_filters('f!yabe/oxybender/utils/asset_vite/vite_for_wp__development_assets', $assets, $manifest, $entry, $options);
    ...
    public function load_production_asset(object $manifest, string $entry, array $options): ?array
    {
         ...
         * @param array  $options  Enqueue options.
         */
        $assets = apply_filters('f!yabe/oxybender/utils/asset_vite/vite_for_wp__production_assets', $assets, $manifest, $entry, $options);
